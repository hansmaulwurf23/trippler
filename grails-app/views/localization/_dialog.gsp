          ...
          <tbody>
              ...
              <tr class="prop">
                  ...
                  <td valign="top" class="value ${hasErrors(bean:localization,field:'code','errors')}">
                      <input type="text" maxlength="250" id="code" name="code" value="${fieldValue(bean:localization,field:'code')}"/>
                  </td>
              </tr>
              ...
              <tr class="prop">
                  ...
                  <td valign="top" class="value ${hasErrors(bean:localization,field:'locale','errors')}">
                      <input type="text" id="locale" name="locale" value="${fieldValue(bean:localization,field:'locale')}"/>
                  </td>
              </tr>
              ...
              <tr class="prop">
                  ...
                  <td valign="top" class="value ${hasErrors(bean:localization,field:'text','errors')}">
                      <textarea rows="5" cols="40" name="text">${fieldValue(bean:localization, field:'text')}</textarea>
                  </td>
              </tr>
